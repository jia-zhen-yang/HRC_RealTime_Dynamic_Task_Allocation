...
Example:
    python batch_real_nores_runner.py ^
      ...
      --simulator real_data_nores_simulation.py ^
...
def run_batch(
    *,
            ...
            row.update(
                {
                    ...
                    "human_time_mode": coerce_result_value(result, "human_time_mode", human_time_mode),
    ...
    event_summary_fields = [
        ...
        "human_time_mode",
        "delay_extra_total",
        "simulated_duration_after_event",
        "nores_makespan",
        "dynamic_makespan_after_event",
        "nores_minus_dynamic",
        "target_task",
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Batch runner for no-rescheduling counterfactual simulations with selectable human real/standard operation-time mode")
    ...
    parser.add_argument(
        "--simulator",
        default="real_data_nores_simulation.py",
    ...
    parser.add_argument(
        ...
        default="real",
        help=(
            "Human operation-time mode passed to real_data_nores_simulation.py. "
            "real = use inferred real/adaptive human durations; "
