...
ROBOT_PORT = 30002
CALLBACK_PORT = 50001
MONITOR_IP = "127.0.0.1" # 我這台電腦自己 (server跟client都跑在同一台電腦)
MONITOR_PORT = 5050
...
def main():
    ...
    print(f"Connected to monitor server {MONITOR_IP}:{MONITOR_PORT}")
    ...
    while True:
        ...
        # ===== 通知 server pick 完成，等待 kit_ready =====
